...
public class BucketFragment extends Fragment {
    ...
    public static final int REQ_CODE_BUCKET_CHANGE = 101;

    @BindView(R.id.recyclerView_fab) RecyclerView recyclerView;
    @BindView(R.id.swipe_refresh_layout_bucket) SwipeRefreshLayout swipeRefreshLayout;
    ...
    public static BucketFragment newInstance(@Nullable String userId,
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragement_recyclerview_fab, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new BucketAdapter(this, new ArrayList<Bucket>(), onLoadMore, isChoosingMode);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogFragment.setTargetFragment(BucketFragment.this, REQ_CODE_NEW_BUCKET);
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                case REQ_CODE_NEW_BUCKET:
                    ...
                    break;
                case REQ_CODE_BUCKET_CHANGE:
                    String bucketId = data.getStringExtra(ShotFragment.KEY_DELETE_BUCKET_ID);
    ...
    private class DeleteBucketTask extends DribbbleTask<Void, Void, Void> {
        ...
        private DeleteBucketTask(String bucketId) {
